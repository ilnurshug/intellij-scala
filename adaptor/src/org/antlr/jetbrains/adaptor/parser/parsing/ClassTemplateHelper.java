...
public class ClassTemplateHelper extends ParserRuleNodeContextHelper implements Helper {
    @Override
    ...
    public void exitEveryRule(ParserRuleContext ctx, PsiBuilder.Marker marker, final Deque<PsiBuilder.Marker> markers) {
        RuleNode t = findRuleNode(ctx, ScalaLangParser.RULE_classParents);

        if (t != null
                && hasTerminalNode((ParserRuleContext)t.getRuleContext(), ScalaLangParser.WITH))
        {
            marker.drop();
        }
        else {
