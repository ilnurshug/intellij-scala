...
import org.antlr.jetbrains.adaptor.parser.parsing.ParserRuleNodeContextHelper;

import java.util.ArrayDeque;
import java.util.Deque;

public class AnnotTypeHelper extends ParserRuleNodeContextHelper implements Helper {
    @Override
